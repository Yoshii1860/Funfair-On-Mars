...
public class CombinationLock : MonoBehaviour
{
    ...
    public UnityAction IncorrectAction;
    private void OnIncorrect() => IncorrectAction?.Invoke();
    ...
    public AudioClip GetUnlockClip() => _unlockClip;
    public AudioClip GetComboButtonClip() => _comboButtonClip;
    public AudioClip GetIncorrectClip() => _incorrectClip;

    [SerializeField] private AudioClip _unlockClip;
    [SerializeField] private AudioClip _incorrectClip;
    [SerializeField] private AudioClip _comboButtonClip;
